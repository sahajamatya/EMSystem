...
<div class="modal fade" id="deleteEventModal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 style="color:#a57d89; font-family: Georgia">Are you sure you want to delete the event with the following specifications?</h3><br>
                <table width="50%" align="center">
                    <tr style="color:#a57d89">
                        <td><label style="font-family: Georgia">Event Name: </label></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr style="color:#a57d89">
                        <td><label style="font-family: Georgia">Type: </label></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr style="color:#a57d89">
                        <td><label style="font-family: Georgia">Host: </label></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr style="color:#a57d89">
                        <td><label style="font-family: Georgia">Venue: </label></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr style="color:#a57d89">
                        <td><label style="font-family: Georgia">Address: </label></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr style="color:#a57d89">
                        <td><label style="font-family: Georgia">Status: </label></td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
            </div>
